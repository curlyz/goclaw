...
export function TtsPage() {
  ...
  const updateProvider = (
    provider: keyof Pick<TtsConfig, "openai" | "elevenlabs" | "edge" | "minimax">,
              ...
              <>
                ...
                <div className="grid gap-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateProvider("openai", { api_base: e.target.value })}
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="grid gap-1.5">
                    ...
                    <Input
                      id="oai-voice"
                      value={draft.openai.voice ?? ""}
                      onChange={(e) => updateProvider("openai", { voice: e.target.value })}
                      placeholder="alloy"
                    />
                  </div>
                </div>
              ...
              <>
                <div className="grid gap-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateProvider("elevenlabs", { api_key: e.target.value })}
                    placeholder="xi-..."
                  />
                </div>
                <div className="grid gap-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateProvider("elevenlabs", { base_url: e.target.value })}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) => updateProvider("elevenlabs", { voice_id: e.target.value })}
                      placeholder="pMsXgVXv3BLzUgSXRplE"
                    />
                  </div>
                  <div className="grid gap-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) => updateProvider("elevenlabs", { model_id: e.target.value })}
            ...
            {draft.provider === "edge" && (
              <>
                <div className="grid gap-1.5">
                  ...
                  <Input
                    id="edge-voice"
                    value={draft.edge.voice ?? ""}
                    onChange={(e) => updateProvider("edge", { voice: e.target.value })}
                    placeholder="en-US-MichelleNeural"
                  />
                </div>
                <div className="grid gap-1.5">
                  ...
                  <Input
                    id="edge-rate"
                    value={draft.edge.rate ?? ""}
                    onChange={(e) => updateProvider("edge", { rate: e.target.value })}
                    placeholder="+0%"
                  />
                </div>
                <p className="text-xs text-muted-foreground">
                  Edge TTS is free and requires no API key. Install with: pip install edge-tts
                </p>
              </>
            )}
              ...
              <>
                <div className="grid gap-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateProvider("minimax", { api_key: e.target.value })}
                  />
                </div>
                <div className="grid gap-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateProvider("minimax", { group_id: e.target.value })}
                ...
                <div className="grid gap-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateProvider("minimax", { api_base: e.target.value })}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-1.5">
                    ...
                    <Input
                      id="mm-model"
                      value={draft.minimax.model ?? ""}
                      onChange={(e) => updateProvider("minimax", { model: e.target.value })}
                  ...
                  <div className="grid gap-1.5">
                    ...
                    <Input
                      id="mm-voice"
                      value={draft.minimax.voice_id ?? ""}
                      onChange={(e) => updateProvider("minimax", { voice_id: e.target.value })}
