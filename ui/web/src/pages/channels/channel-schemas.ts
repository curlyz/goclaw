...
export const configSchema: Record<string, FieldDef[]> = {
  telegram: [
    ...
    },
    {
      ...
      type: "number",
      defaultValue: 50,
      help: "Max pending group messages for context (0 = disabled)",
    },
    {
      key: "stream_mode",
      label: "Stream Mode",
      ...
      options: [
        { value: "off", label: "Off" },
        { value: "partial", label: "Partial (edit messages)" },
      ],
      defaultValue: "off",
    },
    {
    ...
    { key: "link_preview", label: "Link Preview", type: "boolean", defaultValue: true },
    {
      ...
      label: "Allowed Users",
      type: "tags",
      help: "User IDs or @usernames, one per line",
    },
  ],
  discord: [
    {
